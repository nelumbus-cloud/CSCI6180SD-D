...
import { StickyNote, Plus, X, Edit2, Trash2, Save, Loader } from 'lucide-react';
    ...
    const handleUpdateNote = async () => {
        if (editingId) {
            try {
                setSaving(true);
                setError(null);
                const updatedNote = await notesService.updateNote(editingId, {
                    title: newNote.title.trim() || 'Untitled Note',
                    content: newNote.content.trim()
                });
                    ...
                    <CardContent className="p-6 bg-gradient-to-br from-slate-50 to-white">
                        ...
                        {loading ? (
                            <div className="text-center py-12">
                                <Loader className="w-8 h-8 mx-auto mb-4 text-indigo-600 animate-spin" />
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <div>
                                                ...
                                                <textarea
                                                    ...
                                                    rows={4}
                                                    disabled={saving}
                                                    className="w-full px-3 py-2 border border-slate-200 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent resize-none disabled:opacity-50"
                                                />
                                            </div>
